...
{
public WorldDecoratorCollection HitBoxDecorator {
        get; set;
}
public IFont LightFont {
        get; set;
}
public IFont RedFont {
        get; set;
}
public IFont BlueFont {
        get; set;
}
public IFont NameFont {
        get; set;
}
public IBrush cBrush {
        get; set;
}
public IFont cFont {
        get; set;
...
public IBrush RegularBorder {
        get; set;
}
public IBrush RareBrush {
        get; set;
}
public IBrush RareJuggerBrush {
        get; set;
}
public IBrush FrozenBorder {
        get; set;
}
public IBrush RareMinionBrush {
        get; set;
}
public IBrush ChampionBrush {
        get; set;
}
public IBrush BossBrush {
        get; set;
}
public bool JuggernautHighlight {
        get; set;
}
public bool FrozenHighlight {
        get; set;
}
public bool MissingHighlight {
        get; set;
}
public bool ShowRareMinions {
        get; set;
}
public bool ShowDebuffAndCC {
        get; set;
}
public bool ShowBossHitBox {
        get; set;
}
public bool ShowMonsterType {
        get; set;
}
public bool CircleNonIllusion {
        get; set;
}
public float XPos {
        get; set;
...
public string PercentageDescriptor {
        get; set;
}
...
public bool ShowCurses {
        get; set;
}

public IFont BlancoFontA {
        get; set;
}
public IFont NaranjaFontA {
        get; set;
}
public IFont AmarilloFontA {
        get; set;
}
public IFont RojoFontA {
        get; set;
}
public IFont JugFontA {
        get; set;
}
public IFont MoradoFontA {
        get; set;
}
public IFont MarronFontA {
        get; set;
}
public IFont GrisFontA {
        get; set;
}
public IFont AzulFontA {
        get; set;
}
public IFont AzulFFontA {
        get; set;
}
public IFont VerdeFontA {
        get; set;
}
public IFont VerdeCFontA {
        get; set;
}
public IFont TeleportFontA {
        get; set;
}
public IFont HordaFontA {
        get; set;
}
