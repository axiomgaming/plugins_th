...
{
private WorldDecoratorCollection DecoratorRectangle {
        get; set;
}
private WorldDecoratorCollection DecoratorRectangleGray {
        get; set;
}
private WorldDecoratorCollection DecoratorCircle {
        get; set;
}
private WorldDecoratorCollection DecoratorCircleGray {
        get; set;
}
private WorldDecoratorCollection DecoratorHealing {
        get; set;
}
private WorldDecoratorCollection DecoratorDefault {
        get; set;
}
private WorldDecoratorCollection LinePylon {
        get; set;
}
private WorldDecoratorCollection LinePool {
        get; set;
}

private TopLabelDecorator DecoratorPylonNemesys {
        get; set;
}
private TopLabelDecorator DecoratorPopupON {
        get; set;
}
private TopLabelDecorator DecoratorPopupOFF {
        get; set;
}

private string PylonNemesys {
        get; set;
} = string.Empty;
private string TextoPopup {
        get; set;
} = string.Empty;
private IFont TextoFont {
        get; set;
}

private Dictionary<string, int> ShrineCoordReapp {
        get; set;
} = new Dictionary<string, int>();
private Dictionary<uint, ShrineType> PylonBuffType {
        get; set;
}
private Dictionary<ShrineType, ShrineData> ShrinesDic {
        get; set;
} = new Dictionary<ShrineType, ShrineData>();
private List<ShrineType> PylonsGR {
        get; set;
} = new List<ShrineType>() {
...
public bool NotifyInTown {
        get; set;
}
public bool TTSViewPylon {
        get; set;
}
public bool TTSBuffPylon {
        get; set;
}
public string TTSViewPoolText {
        get; set;
}

public string LabelHealingWells  {
        get; set;
}
public string LabelPoolOfReflection {
        get; set;
}
public string LabelPossiblePylon {
        get; set;
}
public bool LabelPylonExchange {
        get; set;
}

public bool HiddenPylonUsed {
        get; set;
}
public bool LineToPylon {
        get; set;
}
public float LineToPylonWidth {
        get; set;
}

public bool CircleHealingWells {
        get; set;
}
public bool CirclePoolOfReflection {
        get; set;
}
public bool ShowPylonSpawn {
        get; set;
}
...
public string TTSView {
        get; set;
}
public string TTSBuffON {
        get; set;
}
public string TTSBuffOFF {
        get; set;
}
public string PopupBuff {
        get; set;
}
public bool GR {
        get; set;
...
public void AfterCollect()
{
        ...
        foreach (uint buff in PylonBuffType.Keys)
        {
                ...
                else if (ShrinesDic[stype].Buff)
                {
                        ...
                        //if (bfinish < Hud.Game.Me.Powers.GetBuff(buff).TimeLeftSeconds[0] - 5) warn()
                }
        }
}
