...
{
public IFont FuenteW {
        get; set;
}
public IFont FuenteY {
        get; set;
}
public IFont FuenteG {
        get; set;
}
public IFont FuenteB {
        get; set;
}
public int info {
        get; set;
...
public float LineHeightPC {
        get; set;
} = 0.85f;                                               // Line height modifier.

public bool Debug_On {
        get; set;
}
public IKeyEvent ToggleKeyEvent1 {
        get; set;
}                                                       // Show/Hide.
public IKeyEvent ToggleKeyEvent2 {
        get; set;
}                                                       // Display info mode.
public IKeyEvent ToggleKeyEvent3 {
        get; set;
}                                                       // Reposition to mouse cursor.

public bool ShowBuffsExcluded  {
        get; set;
}

public Dictionary<uint, int> FixIndexSkills {
        get; set;
}

public uint[] ExcludedSnos {
        get; set;
} = new uint[]
{
