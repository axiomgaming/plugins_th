namespace Turbo.Plugins.RuneB
{
    ...
    public class BuffLabelsPlugin : BasePlugin, IInGameTopPainter
    {
		...
		public IBrush BackgroundBrushAT { get; set; }
        public IBrush BackgroundBrushCD { get; set; }
        public IBrush BackgroundBrushRR { get; set; }
        ...
        public override void Load(IController hud)
        {
            ...
            BackgroundBrushOC = Hud.Render.CreateBrush(100, 255, 10, 10, 0);    // Oculus
            BackgroundBrushIS = Hud.Render.CreateBrush(100, 185, 220, 245, 0);   // Inner Sanctuary
			BackgroundBrushAT = Hud.Render.CreateBrush(164, 192, 0, 0, 0);   // Attack Buff  164, 192, 0, 0, 0
			BackgroundBrushCD = Hud.Render.CreateBrush(164, 0, 192, 192, 0);   // CDR Buff 164, 0, 192, 192, 0
			BackgroundBrushRR = Hud.Render.CreateBrush(164, 164, 164, 0, 0);   // Resource Buff 
        ...
        public void PaintTopInGame(ClipState clipState)
        {
            ...
            {// Fix to make it possible to set oculus & sanc to false through customize. this is a bit overheady
				...
				Labels.Add(new Label("AT", 483606, 2, BackgroundBrushAT, ShowAT));
				Labels.Add(new Label("CD", 483606, 8, BackgroundBrushCD, ShowCD));
				Labels.Add(new Label("RR", 483606, 5, BackgroundBrushRR, ShowRR));
