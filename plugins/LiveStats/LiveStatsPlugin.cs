...
public IBrush BgBrushAlt {
        get; set;
}
public IBrush BgBrushTitle {
        get; set;
}
public IBrush BarBgBrush {
        get; set;
}
public IBrush SelectedBgBrush {
        get; set;
}
...
public float ExpandLabelHook {
        get; private set;
}
public float ExpandLabelTopHook {
        get; private set;
}

// Compute placement and dimensions dynamically, similar to AbstractTopLabelList
public Func<float> WidthFunc {
        get; set;
}                                                  // Width of a label
public Func<float> HeightFunc {
        get; set;
}                                                   // Height of a label

// Session clock time display
public TopLabelDecorator SessionLabel {
        get; set;
}
public TopLabelDecorator UptimeLabel {
        get; set;
}
public TopLabelDecorator Pin {
        get; set;
}

public IFont PinFont {
        get; set;
}
public IFont PinnedFont {
        get; set;
}
public int HoverPinDelay {
        get; set;
} = 700;                                        // Milliseconds
public int RepeatPinDelay {
        get; set;
} = 2000;                                         // Milliseconds - Keep hovering over a pin to re/un-pin (0 = don't repeat until mouse is moved away from pin first)

// Hover state
public TopLabelDecorator SelectedLabel {
        get; private set;
}
public TopLabelDecorator SelectedTopLabel {
        get; private set;
}
public TopLabelDecorator PinnedLabel {
        get; private set;
}
public TopLabelDecorator PinnedTopLabel {
        get; private set;
}
public RectangleF SelectedRectangle {
        get; private set;
}
public RectangleF SelectedTopRectangle {
        get; private set;
}
//public RectangleF PinnedRectangle { get; private set; }
public float PinnedX {
        get; private set;
}
public float PinnedTopX {
        get; private set;
}
...
// Bag Space Widget
public bool BagWidget {
        get; set;
}
public TopLabelDecorator RedDecorator {
        get; set;
}
public TopLabelDecorator YellowDecorator {
        get; set;
}
public TopLabelDecorator GreenDecorator {
        get; set;
}
...
public IKeyEvent ToggleKeyEvent {
        get; set;
}
public Key HotKey
{
...
// Bool Options
public bool SessionHelper {
        get; set;
} = true;                                               // Show the Session Module in the bar
public bool TimeTracker {
        get; set;
} = true;                                             // Show the Time Tracker Module in the bar
public bool LockPinInCombat {
        get; set;
} = false;
