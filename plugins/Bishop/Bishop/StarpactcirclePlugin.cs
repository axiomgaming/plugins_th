                        ...
                        case (ActorSnoEnum)217142:
                            ...
                            if (Hud.Game.Me.HeroClassDefinition.HeroClass == HeroClass.Wizard)
                            {
                                ...
                                if (Hud.Game.Me.HeroClassDefinition.HeroClass == HeroClass.Wizard && remaining < 0.1 && remaining > 0)
                                {
                                    ...
                                    {
                                        meteorvisionstringDeco.Paint(layer, actor, actor.FloorCoordinate, "+" + Hud.Sno.SnoPowers.Wizard_Meteor.NameLocalized + " + " + Hud.Sno.SnoPowers.Wizard_ArcaneTorrent.NameLocalized);
                                        break;
                                    }
                                    ...
                                    {
                                        meteorvisionstringDeco.Paint(layer, actor, actor.FloorCoordinate, "+" + Hud.Sno.SnoPowers.Wizard_Meteor.NameLocalized + " + " + Hud.Sno.SnoPowers.Wizard_Disintegrate.NameLocalized);
                                        break;
                                    }
                                    ...
                                    {
                                        meteorvisionstringDeco.Paint(layer, actor, actor.FloorCoordinate, "+" + Hud.Sno.SnoPowers.Wizard_Meteor.NameLocalized + " + " + Hud.Sno.SnoPowers.Wizard_RayOfFrost.NameLocalized);
                                        break;
                                    }
