...
{
public bool DrawClassOnIcons {
        get; set;
}                                                       //Draw ClassNames per Dafault on every Stricken Icon
...
public TopLabelDecorator StackCountDecorator {
        get; set;
}
public float xPos {
        get; set;
...
public SharpDX.DirectInput.Key Key {
        get; set;
}
public SharpDX.DirectInput.Key Key2 {
        get; set;
}
public SharpDX.DirectInput.Key Key3 {
        get; set;
}
public SharpDX.DirectInput.Key Key4 {
        get; set;
}
public SharpDX.DirectInput.Key Key5 {
        get; set;
}

public SharpDX.DirectInput.Key Key6 {
        get; set;
}
public SharpDX.DirectInput.Key Key7 {
        get; set;
}
public SharpDX.DirectInput.Key Key8 {
        get; set;
}
public SharpDX.DirectInput.Key Key9 {
        get; set;
}
public SharpDX.DirectInput.Key Key10 {
        get; set;
}
public SharpDX.DirectInput.Key Key11 {
        get; set;
}
...
public void PaintTopInGame(ClipState clipState)
{
        ...
        if (!IsGuardianAlive)
        {
                //before we clean up, output the final stack rate for say 10s
                for (int i = 0; i < 4; i++)
                {
                        StackCount[i] = 0;
                        StackStart[i] = 0;
